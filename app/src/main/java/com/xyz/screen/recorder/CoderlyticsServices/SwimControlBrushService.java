...
public class SwimControlBrushService extends Service implements OnClickListener {
    ...
    public void onCreate() {
        ...
        this.floatingControls = (LinearLayout) ((LayoutInflater) getApplicationContext().getSystemService("layout_inflater")).inflate(R.layout.contetn_bubblebutton_control_brush, null);
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    if (action == 0) {
                        ...
                        if (isOverRemoveView) {
                            prefs.edit().putBoolean(CoderlyticsConstants.PREFS_TOOLS_BRUSH, false).apply();
                            stopSelf();
                        } else {
                        ...
                        swimControlBrushService.isOverRemoveView = swimControlBrushService.isPointInArea(swimControlBrushService.overlayViewLocation[0], overlayViewLocation[1], removeViewLocation[0], removeViewLocation[1], mRemoveView.getWidth());
                        if (isOverRemoveView) {
                            if (this.oneRun) {
                                if (VERSION.SDK_INT < 26) {
                                    vibrate.vibrate(200);
    ...
    public void openBrsuh() {
        startService(new Intent(this, ScRecBrushService.class));
    }
